...
void GetCuadranteTests(){
	...
	assert(1 == GetCuadrante(a));
	assert(3 == GetCuadrante(b));
	assert(0 == GetCuadrante(c));
	assert(2 == GetCuadrante(d));
	assert(4 == GetCuadrante(f));
	assert(0 == GetCuadrante(g));
	assert(4 == GetCuadrante(h));
	assert(4 == GetCuadrante(origen));
}
